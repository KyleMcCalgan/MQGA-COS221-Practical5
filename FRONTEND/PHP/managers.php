    ...
    <div class="container">
        ...
        <div class="genman">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div class="display-field">
                        <span id="display-name" class="info">Loading...</span>
                ...
                <div class="form-group">
                    ...
                    <div class="display-field">
                        <span id="display-logo" class="info">Loading...</span>
                ...
                <div class="form-group">
                    ...
                    <div class="display-field">
                        <span id="display-domain" class="info">Loading...</span>
                ...
                <div class="form-group">
                    ...
                    <div class="display-field">
                        <span id="display-type" class="info">Loading...</span>
            ...
            <div id="delete-admin-modal" class="modal">
                <div class="modal-content">
                    <span id="close-delete-admin-modal" class="close-button">×</span>
                    <h2>Confirm Delete Admin</h2>
                    <div id="delete-admin-message"></div>
                    <div class="centerbutton">
                        <button id="cancel-delete-admin" class="blackbutton normalbutton">Cancel</button>
                        <button id="confirm-delete-admin" class="blackbutton deletebtn normalbutton">Delete</button>
                    </div>
                </div>
            </div>

            <h2>Admins</h2>
            <div class="adminscont" id='adminscont'>
                <div class="storerow">
                    <h3 class="amount rowinfo">1</h3>
                    <h3 class="adname rowinfo">Name</h3>
                    <h3 class="ademail rowinfo">Email</h3>
