document.addEventListener('DOMContentLoaded', function(){
    ...
    function populateAndConfigureModal(book){
        ...
        if (userType === 'super'){
            ...
            if (storePriceField) storePriceField.disabled = false;
            if (storeRatingField) storeRatingField.disabled = false;
        }
    }
    ...
    function showMessage(message, isError, isPageLevelAlert = true, context = 'page'){
        ...
        if (context === 'modal' && editBookModalElement){
            const modalFooter = editBookModalElement.querySelector('.modal-footer');
